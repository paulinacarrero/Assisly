...
form.addEventListener("submit", async (e) => {
    ...
    try {
        ...
        // Guardar sesión — nombre completo para docente y estudiante
        ...
        // Geolocalización de tu compañera — sin cambios
            ...
            (position) => {
                ...
                if (distancia <= RADIO_PERMITIDO) {
                    ...
                    document.getElementById("estado").innerHTML =
                        "❌ Debes estar dentro de la universidad";
                    alert("Acceso bloqueado");
                }
            },
            (error) => {
                console.log(error);
                document.getElementById("estado").innerHTML = "Debes permitir ubicación";
            },
            {
